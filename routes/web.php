...
use KKPhim\ThemeToro\Controllers\ThemeToroController;
...
Route::group([
    ...
    Route::post(sprintf('/%s/{movie}/{episode}/report', config('kkphim.routes.movie', 'phim')), [ThemeToroController::class, 'reportEpisode'])->name('episodes.report');
    Route::post(sprintf('/%s/{movie}/rate', config('kkphim.routes.movie', 'phim')), [ThemeToroController::class, 'rateMovie'])->name('movie.rating');
